...
void sejarahHima() {
    ...
    cout << endl << "Himakom terbentuk pada tahun 2012. Awalnya di Ilmu Komputer sendiri memiliki nama KOMIK (Komunitas Ilmu Komputer)" << endl;
...
void visiMisiHima(){
    ...
    cout << ** Visi Himakom **;
    cout << endl << "Menciptakan sebuah himpunan yang inklusif, inovatif, dan kompetitif" << endl;
    ...
    cout << endl << " ** Misi Himakom ** ";
    cout << endl << "1.Mendorong inovasi dalam kepemimpinan untuk menciptakan perubahan yang signifikan" << endl;
...
void strukturHima(){
    cout << endl << " * Terdapat Presidium, Badan Khusus, Bidang Hima dan Biro Hima * " << endl;
    cout << "1. Presidium" << endl;
    cout << "2. Badan Khusus" << endl;
    cout << "3. Bidang Hima" << endl;
